...
public class WorkflowController {
    ...
    public WorkflowController(DiagnosisWorkflowService diagnoses, ReportWorkflowService reports, HashChainAuditService audit) { this.diagnoses = diagnoses; this.reports = reports; this.audit = audit; }
    ...
    @ExceptionHandler({DiagnosisWorkflowService.NotFound.class, ReportWorkflowService.NotFound.class})
    ...
    @ExceptionHandler({DiagnosisWorkflowService.Conflict.class, ReportWorkflowService.Conflict.class})
